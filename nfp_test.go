...
func TestNFP(t *testing.T) {
	for _, item := range [][]string{
		...
		{"0.00e+00", "[{Positive [{0 ZeroPlaceHolder []} {. DecimalPoint []} {00 ZeroPlaceHolder []} {e+ Scientific []} {00 ZeroPlaceHolder []}]}]"},
		...
		{"mmss.0", "[{Positive [{mm DateTimes []} {ss DateTimes []} {. Literal []} {0 ZeroPlaceHolder []}]}]"},
		{"##0.0e+0", "[{Positive [{## HashPlaceHolder []} {0 ZeroPlaceHolder []} {. DecimalPoint []} {0 ZeroPlaceHolder []} {e+ Scientific []} {0 ZeroPlaceHolder []}]}]"},
		...
		{`0`, "[{Positive [{0 ZeroPlaceHolder []}]}]"},
		{`0"abcde".0"??"000E+00`, "[{Positive [{0 ZeroPlaceHolder []} {abcde Literal []} {. Literal []} {0 ZeroPlaceHolder []} { Literal []} {?? DigitalPlaceHolder []} {000 ZeroPlaceHolder []} {E+ Scientific []} {00 ZeroPlaceHolder []}]}]"},
		{`0%`, "[{Positive [{0 ZeroPlaceHolder []} {% Percent []}]}]"},
		...
		{`0.00000000E+00`, "[{Positive [{0 ZeroPlaceHolder []} {. DecimalPoint []} {00000000 ZeroPlaceHolder []} {E+ Scientific []} {00 ZeroPlaceHolder []}]}]"},
		{`0.0000E+00`, "[{Positive [{0 ZeroPlaceHolder []} {. DecimalPoint []} {0000 ZeroPlaceHolder []} {E+ Scientific []} {00 ZeroPlaceHolder []}]}]"},
		...
		{`HH[MM]`, "[{Positive [{HH DateTimes []} {MM DateTimes []}]}]"},
		{`HH[M]`, "[{Positive [{HH DateTimes []} {M DateTimes []}]}]"},
		...
		{`[=0]?;[<4.16666666666667][hh]:mm:ss;[hh]:mm`, "[{Positive [{=0 Condition [{{= Operator []} } {{0 Operand []} }]} {? DigitalPlaceHolder []}]} {Negative [{<4.16666666666667 Condition [{{< Operator []} } {{4.16666666666667 Operand []} }]} {hh DateTimes []} {: Literal []} {mm DateTimes []} {: Literal []} {ss DateTimes []}]} {Zero [{hh DateTimes []} {: Literal []} {mm DateTimes []}]}]"},
		...
		{`dd\-mmm\-yyyy\ hh:mm:ss.000`, "[{Positive [{dd DateTimes []} {- Literal []} {mmm DateTimes []} {- Literal []} {yyyy DateTimes []} {  Literal []} {hh DateTimes []} {: Literal []} {mm DateTimes []} {: Literal []} {ss DateTimes []} {. Literal []} {000 ZeroPlaceHolder []}]}]"},
		{`dd\/mm\/yy`, "[{Positive [{dd DateTimes []} {/ Literal []} {mm DateTimes []} {/ Literal []} {yy DateTimes []}]}]"},
		{`dd\/mm\/yyyy`, "[{Positive [{dd DateTimes []} {/ Literal []} {mm DateTimes []} {/ Literal []} {yyyy DateTimes []}]}]"},
		{`ddd`, "[{Positive [{ddd DateTimes []}]}]"},
		{`dddd`, "[{Positive [{dddd DateTimes []}]}]"},
		...
		{`mm:ss`, "[{Positive [{mm DateTimes []} {: Literal []} {ss DateTimes []}]}]"},
		{`mm:ss.0;@`, "[{Positive [{mm DateTimes []} {: Literal []} {ss DateTimes []} {. Literal []} {0 ZeroPlaceHolder []}]} {Text [{@ TextPlaceHolder []}]}]"},
		...
		{`yyyy\-mm\-dd\Thhmmss.000`, "[{Positive [{yyyy DateTimes []} {- Literal []} {mm DateTimes []} {- Literal []} {dd DateTimes []} {T Literal []} {hh DateTimes []} {mm DateTimes []} {ss DateTimes []} {. Literal []} {000 ZeroPlaceHolder []}]}]"},
	} {
