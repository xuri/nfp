...
func TestNFP(t *testing.T) {
	for _, item := range [][]string{
		...
		{`#''.#`, "[{Positive [{# HashPlaceHolder []} {. Literal []} {# HashPlaceHolder []}]}]"},
		{`#"''".#`, "[{Positive [{# HashPlaceHolder []} {'' Literal []} {. Literal []} {# HashPlaceHolder []}]}]"},
		{"[s].00.", "[{Positive [{s ElapsedDateTimes []} {. DecimalPoint []} {00 ZeroPlaceHolder []} {. Literal []}]}]"},
		{"[s]\".00\"", "[{Positive [{s ElapsedDateTimes []} {. Literal []} {00 ZeroPlaceHolder []}]}]"},
		{"[s].##", "[{Positive [{s ElapsedDateTimes []} {. Literal []} {## HashPlaceHolder []}]}]"},
		...
		{`0`, "[{Positive [{0 ZeroPlaceHolder []}]}]"},
		{`0"abcde".0"??"000E+00`, "[{Positive [{0 ZeroPlaceHolder []} {abcde Literal []} {. DecimalPoint []} {0 ZeroPlaceHolder []} { Literal []} {?? DigitalPlaceHolder []} {000 ZeroPlaceHolder []} {E+ Exponential []} {00 ZeroPlaceHolder []}]}]"},
		{`0%`, "[{Positive [{0 ZeroPlaceHolder []} {% Percent []}]}]"},
		...
		{`[Magenta]0.00`, "[{Positive [{Magenta Color []} {0 ZeroPlaceHolder []} {. DecimalPoint []} {00 ZeroPlaceHolder []}]}]"},
		{`[RED]#.##`, "[{Positive [{RED Color []} {# HashPlaceHolder []} {. Literal []} {## HashPlaceHolder []}]}]"},
		{`[Red]#.##`, "[{Positive [{Red Color []} {# HashPlaceHolder []} {. Literal []} {## HashPlaceHolder []}]}]"},
